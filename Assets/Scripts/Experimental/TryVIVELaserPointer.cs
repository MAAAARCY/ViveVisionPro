...
public class TryVIVELaserPointer : MonoBehaviour
{
    [SerializeField]
    ...
    private void Update()
    {
        ...
        //Debug.Log("UV_X:" + hit.lightmapCoord + ", UV_Y:");
        ...
        if (bHit && previousContact != hit.transform)
        {
            ...
            Debug.Log("UV_X:" + hit.lightmapCoord.x + ", UV_Y:" + hit.lightmapCoord.y);
        }
        if (!bHit)
        {
            previousContact = null;
        ...
        if (pointerInCollider)
        {
            ...
            Debug.Log("hit_X:" + hit.point.x + ", hit_Y:" + hit.point.y);
        }
